...
//          console.log("BCM dta:" +response.data);
      ...
      for(var bcmPanelOn = 0;bcmPanelOn < $rootScope.bcmPanelOnArr.length;bcmPanelOn++){
          $rootScope.bcmDeviceLabel = bcmDevice.Id + "/" + $rootScope.bcmPanelOnArr[bcmPanelOn];
    ...
    $scope.invokeDeviceStatusService = function() {
        ...
        $scope.svg_bcmLoad = function(deviceStatus){
                       ...
                       var svg_bcm = document.createElementNS("http://www.w3.org/2000/svg", 'svg'); //create svg element
                        ...
                        /*var bcmLabelId = document.createElementNS("http://www.w3.org/2000/svg",'tspan');
                        bcmLabel.append(bcmLabelId);
                        bcmLabelId.setAttribute("id","bcmLabelId");
                        bcmLabelId.setAttribute("x","85.836708");
                        bcmLabelId.setAttribute("y","163.11371");
                        bcmLabelText.textContent = "7/1";
                        bcmLabelId.setAttribute("style","fill:#ffffff;fill-opacity:1;stroke:none;stroke-width:0.26458332");*/
