    ...
    app.controller('metersBranchController', function($scope, $http, $q, $timeout, $location, $interval, $rootScope){
        ...
        $scope.svg_bcmBranchRight = function(){
            ...
            $("#bcmBranchLeftContainer").append(svg_bcmBranchRight);
            ...
            bcmBranchTxtZero.textContent = "0";
        ...
        $scope.svg_bcmBranchLeft = function(){
            ...
            $("#bcmBranchLeftContainer").append(svg_bcmBranchLeft);
            //branch status bar group
            var branchStatusBarContainer = document.createElementNS("http://www.w3.org/2000/svg", 'g'); //Create a defs in SVG's namespace
            branchStatusBarContainer.setAttribute("id","bcmBranchStatusGrp"); //Set g's id
            branchStatusBarContainer.setAttribute("transform","translate(0,-273)"); 
        ...
        $scope.bcmPanelBranch = function(){
            ...
            //mannually passing the device ID '7' and the panel number '1' which need to be fetched on click
               var deferred = $q.defer();
               var promises = [];
               ...
               var bcmPanelBranchReq = $q.all(promises).then(function(results){
                   console.log(results);
                   $scope.bcmPanelBranchResponse = results.data;
