    ...
    app.controller('metersBranchController', function($scope, $http, $q, $timeout, $location, $interval, $rootScope){
        $rootScope.activeEventsDisplay = false;
        $scope.branchNumbers = [];
        $scope.numOfCols = 3;
        //function to draw the BCM Branch right aligned svg: START
        $scope.svg_bcmBranchRight = function(status){
            console.log(status)
            var svgBcmBranchRightWrapper = document.createElement("div");
            svgBcmBranchRightWrapper.setAttribute("class","col-xs-6");
            svgBcmBranchRightWrapper.setAttribute("id","branchRightWrapper");
            ...
            svgBcmBranchRightWrapper.append(svg_bcmBranchRight);
            ...
            branchStatusBar.setAttribute("y","281.11438");                   
            branchStatusBar.setAttribute("x","2.5008597");
            branchStatusBar.setAttribute("ry","2.0287354e-015");                   
            branchStatusBar.setAttribute("height","3.9982803");
            branchStatusBar.setAttribute("width","28.99828");
            ...
            branchHandleBar.setAttribute("y","1.1135037");                   
            branchHandleBar.setAttribute("x","24.209337");
            branchHandleBar.setAttribute("ry","1.7759147e-015");                   
            branchHandleBar.setAttribute("height","18.000078");
            branchHandleBar.setAttribute("width","4.0000772");
            ...
            branchTextContainer1.setAttribute("x",'24.738543');
            ...
            branchTextContainer2.setAttribute("x",'3.494705');
            branchTextContainer2.setAttribute("y",'23.272396');
        ...
        $scope.svg_bcmBranchLeft = function(status){
            ...
            svgBcmBranchLeftWrapper.append(svg_bcmBranchLeft);
            //branch status bar group
            var branchStatusBarContainer = document.createElementNS("http://www.w3.org/2000/svg", 'g'); //Create a defs in SVG's namespace
            branchStatusBarContainer.setAttribute("id","bcmBranchStatusGrp"); //Set g's id
            branchStatusBarContainer.setAttribute("transform","translate(0,-273)"); 
        ...
        $scope.drawBcmPanelBranch = function(panelBranchNum,panelBranchState,panelBranchStatus){
            ...
            for(var brNum=0;brNum <= panelBranchNum.length-1;brNum++){
                console.log(panelBranchNum[brNum]);
                if(panelBranchNum[brNum]%2 != 0){
                    console.log(panelBranchNum[brNum]%(parseInt(panelBranchNum.length)/$scope.numOfCols) === 0);
                    if(panelBranchNum[brNum]%(parseInt(panelBranchNum.length)/$scope.numOfCols) === 0){
                       var bcmPanelBranchCol = angular.element("<div class='col-xs-4' id='brCol'></div>");
                        ...
                        $scope.svg_bcmBranchRight(panelBranchStatus);
                    }
                   $scope.svg_bcmBranchRight(panelBranchStatus[brNum]); 
                }
                else{
                    $scope.svg_bcmBranchLeft(panelBranchStatus[brNum]);
                }
            }
        }
